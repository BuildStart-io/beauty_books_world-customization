...
INSERT INTO beauty_books_world_customization.platform_settings (key, value)
VALUES (
  'plan_limits',
  '{
...
-- ----------------------------------------------------------------------------
-- INSERT INTO beauty_books_world_customization.profiles (user_id, email, full_name, plan_tier, billing_cycle_start)
